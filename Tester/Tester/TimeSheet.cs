    ...
    class TimeSheet
    {
        ...
        public void timeSheetSelect(string id)
        {
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    TimeIO t1 = new TimeIO(((String)dr.GetValue(1)), (DateTime)dr.GetValue(2), (DateTime)dr.GetValue(3), (String)dr.GetValue(4), (int)dr.GetValue(0), (bool)dr.GetValue(5), (bool)dr.GetValue(6));
                    getTS().Add(t1);
                }
            }
            catch (Exception e)
